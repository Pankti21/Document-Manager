    ...
    <div className="m-5">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Form.Group>
          ...
          <Controller defaultValue="" name="firstName" control={control} render={({ field }) => <Form.Control type="text" placeholder="First Name" {...field} />} />
        </Form.Group>
        <p className="errors">{errors.firstName?.message}</p>
        <Form.Group>
          <Form.Label>Last Name</Form.Label>
          <Controller defaultValue="" name="lastName" control={control} render={({ field }) => <Form.Control type="text" placeholder="Last Name" {...field} />} />
        </Form.Group>
        <p className="errors">{errors.lastName?.message}</p>
        <Form.Group>
          <Form.Label>Email Id</Form.Label>
          <Controller defaultValue="" name="email" control={control} render={({ field }) => <Form.Control type="email" placeholder="Email" {...field} />} />
        </Form.Group>
        <p className="errors">{errors.email?.message}</p>
        <Form.Group>
          <Form.Label>Password</Form.Label>
          <Controller defaultValue="" name="password" control={control} render={({ field }) => <Form.Control type="password" placeholder="Password" {...field} />} />
        </Form.Group>
